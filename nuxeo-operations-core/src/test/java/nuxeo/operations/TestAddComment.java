...
@Deploy("nuxeo.operations.nuxeo-operations-core")
public class TestAddComment {
    ...
    public void shouldCallTheOperation() throws OperationException {
        ...
        DocumentModel doc = (DocumentModel) automationService.run(ctx, AddComment.ID);
    ...
    public void shouldCallWithParameters() throws OperationException {
        ...
        DocumentModel doc = (DocumentModel) automationService.run(ctx, AddComment.ID, params);
